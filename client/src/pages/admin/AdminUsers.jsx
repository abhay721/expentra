        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="flex items-center gap-3">
                    <div className="p-2 bg-blue-50 rounded-lg">
                        <MdPeople className="w-7 h-7 text-blue-600" />
                    </div>
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">User Management</h1>
                        <p className="text-sm text-gray-600 mt-0.5">Manage platform users and their accounts</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-xs font-medium text-gray-600 uppercase">Blocked</p>
                ...
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[85vh] flex flex-col">
                        <div className="px-5 py-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                            <div>
                                <h2 className="text-lg font-semibold text-gray-900">User Expenses</h2>
                                <p className="text-sm text-gray-600 mt-0.5">{selectedUser.name} • {selectedUser.email}</p>
                            </div>
                            <button
                        ...
                        <div className="flex-1 overflow-y-auto p-5">
                            {loadingExpenses ? (
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-gray-600">No expenses found for this user</p>
                                </div>
                            ) : (
                                <div className="space-y-3">
                                    {userExpenses.map(exp => (
                                        <div key={exp._id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
                                            <div className="flex items-center gap-3 flex-1">
                                                <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                                                    <MdCategory className="w-5 h-5 text-blue-600" />
                                                </div>
                                                <div className="flex-1">
                                                    <p className="text-sm font-medium text-gray-900">{exp.title || 'No description'}</p>
                                                ...
                                                <div className="text-right">
                                                    <p className="text-base font-bold text-green-600">₹{exp.amount.toLocaleString()}</p>
                                                </div>
                                            </div>
                                            <button
                                                onClick={() => handleDeleteExpense(exp._id)}
                                                className="p-1.5 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded transition ml-2"
                ...
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
                        <div className="px-5 py-4 bg-gray-50 border-b border-gray-200">
                            ...
                            <p className="text-sm text-gray-600 mt-0.5">Modify user details and permissions</p>
                        </div>
                        <form onSubmit={handleSaveEdit} className="p-5 space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Force Password Reset</label>
                                <input
                                    type="text"
