...
const Settlement = () => {
    ...
    const SettlementCard = ({ settlement, status }) => {
        ...
        const statusStyles = {
            pending: 'border-gray-100 bg-card hover:border-primary/20',
            overdue: 'border-red-100 bg-red-50/20 hover:border-red-200',
            paid: 'border-gray-50 bg-gray-50/30 grayscale'
        };
            ...
            <div className={`p-6 rounded-2xl border transition-all duration-300 hover:shadow-lg shadow-sm ${statusStyles[status]}`}>
                <div className="flex items-start justify-between mb-5">
                    <div className="flex items-center gap-4">
                        <div className={`w-12 h-12 rounded-xl bg-background flex items-center justify-center shadow-sm border border-gray-50`}>
                            {isFromMe ? (
                                <MdCallMade className="w-6 h-6 text-red-500" />
                            ) : isToMe ? (
                        ...
                        <div>
                            ...
                            <h4 className={`text-2xl font-black tracking-tight ${isFromMe ? 'text-red-600' : isToMe ? 'text-secondary' : 'text-textColor'}`}>
                                ₹{settlement.amount.toLocaleString()}
                            </h4>
                        </div>
                    </div>
                    {status === 'overdue' && (
                        <div className="w-8 h-8 bg-red-500 text-white rounded-lg flex items-center justify-center shadow-md shadow-red-200 animate-pulse">
        ...
        <div className="max-w-6xl mx-auto px-4 py-8 space-y-10 bg-background min-h-screen pb-24">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
                <div>
                    ...
                    <p className="text-sm font-semibold text-gray-400 mt-1 uppercase tracking-widest">{groupData?.name || 'Active Group'}</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="bg-card rounded-[32px] p-8 border border-gray-100 shadow-sm relative overflow-hidden group">
                    ...
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4">Total Payable</p>
                    <div className="flex items-center justify-between">
                        <h2 className="text-4xl font-black text-red-600 tracking-tighter">₹{totalUserOwes.toLocaleString()}</h2>
                    ...
                    <p className="text-[10px] font-bold text-gray-300 mt-6 uppercase tracking-widest">You need to settle back</p>
                </div>
            </div>
            ...
            {overdueReimbursements.length > 0 && (
                <div className="animate-in fade-in slide-in-from-top-4 duration-500">
                    <div className="flex items-center justify-between mb-6 px-2">
                        ...
                        <span className="px-4 py-1.5 bg-red-500 text-white text-[10px] font-black rounded-full shadow-lg shadow-red-200">
            ...
            <div>
                <div className="flex items-center justify-between mb-6 px-2">
                    ...
                    <span className="px-4 py-1.5 bg-background border border-gray-100 text-[10px] font-black rounded-full text-gray-400 tracking-widest uppercase">
                        {pendingReimbursements.length} Open
                    </span>
                </div>

                {pendingReimbursements.length === 0 && overdueReimbursements.length === 0 ? (
                    <div className="bg-card rounded-[40px] border border-gray-100 p-24 text-center shadow-sm relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-sm font-semibold text-gray-400 mt-2 max-w-xs mx-auto uppercase tracking-widest">You are all squared with the group members.</p>
                        </div>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-card rounded-[32px] border border-gray-100 shadow-sm overflow-hidden mb-12">
                <div className="px-8 py-6 border-b border-gray-50 flex items-center justify-between bg-gray-50/30">
                    ...
                    <span className="text-[10px] font-black text-gray-300 uppercase tracking-widest">{balances.length} Members</span>
                </div>
                <div className="divide-y divide-gray-50">
                    {balances.map((bal, idx) => {
                        ...
                        return (
                            <div key={idx} className="px-8 py-6 flex items-center justify-between hover:bg-gray-50/50 transition-all duration-300 group">
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-[9px] font-bold text-gray-300 uppercase tracking-tighter opacity-70">
                    ...
                    <div className="bg-card w-full max-w-sm rounded-[40px] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border border-white/20">
                        ...
                        <div className="bg-primary px-8 py-8 flex justify-between items-center relative overflow-hidden">
                            ...
                            <button
                                ...
                                className="w-10 h-10 flex items-center justify-center hover:bg-white/10 rounded-2xl transition text-white relative z-10"
                            >
                        ...
                        <div className="p-8 space-y-8">
                            <div className="text-center py-4 bg-background rounded-[32px] border border-gray-50 shadow-inner">
                                <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 leading-none">
                                        ...
                                        <button
                                            ...
                                            className={`w-full px-6 py-4 rounded-2xl border text-left transition-all duration-300 flex items-center justify-between ${
                                                paymentMethod === method
                                                    ...
                                                    : 'border-gray-100 text-gray-500 hover:border-primary/20 bg-background/50'
                                                }`}
                                        >
